CREATE DATABASE  IF NOT EXISTS `shopping_webapp` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `shopping_webapp`;
-- MySQL dump 10.13  Distrib 8.0.21, for Win64 (x86_64)
--
-- Host: localhost    Database: shopping_webapp
-- ------------------------------------------------------
...
INSERT INTO `customer` (`customer_id`, `username`, `password`, `first_name`, `last_name`, `email`, `phone_number`, `address_id`, `role`) VALUES (1,'admin1','ShoppingApp1234','Lori','White','admin1@gmail.com','000-000-0000',7,'admin'),(2,'dude420','Surfer-Br0','Oscar','Brown','oscar.brown@gmail.com','908-445-0424',1,'customer'),(3,'flowergirl1','lily_of_the_valley99','Prudence','Halliwell','prudence.halliwell@gmail.com','830-775-9185',2,'customer'),(4,'jojobi','Joseph#99','Joseph','Joestar','joseph.joestar@gmail.com','909-456-9880',4,'customer'),(5,'KellyFlowers','password12E%','Kelly','Flowers','kelly.flowers@gmail.com','704-888-0699',3,'customer'),(6,'violet99','Hello!55','Jane','Brown','laura.brown@gmail.com','732-367-5260',1,'customer'),(7,'violetrose','Javahome$2','Jane','Doe','jane.doe@gmail.com','000-000-0000',5,'customer');
...
CREATE TABLE `invoice` (
  ...
  CONSTRAINT `customer_invoice` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `product` (
  ...
  `top_image` varchar(4000) DEFAULT NULL,
...
INSERT INTO `product` (`product_id`, `name`, `top_image`, `description`, `price`, `stock`) VALUES (1,'Jacket',NULL,'Basic Jacket',20,5),(2,'Jeans',NULL,'Basic pair of Jeans',10,5),(3,'Shirt',NULL,'Basic Shirt',5,11);
...
--
-- Dumping events for database 'shopping_webapp'
--
...
--
-- Dumping routines for database 'shopping_webapp'
--
...
BEGIN
    ...
    select invoice_product_id into @toDelete1 from invoice_product left join invoice on invoice_product.invoice_id = invoice.invoice_id left join customer on invoice.customer_id = customer.customer_id where `customer.role` = 'guest' and invoice_product.can_return = 0;
    ...
    delete from customer where customer_id = @toDelete3;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2020-11-11 16:09:02
